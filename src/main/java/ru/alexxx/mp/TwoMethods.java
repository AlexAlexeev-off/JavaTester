...
//      TwoMethods m2 = new TwoMethods();
        ...
        new Thread(() -> TwoMethods.method2a(a1, 0)).start();
        new Thread(() -> TwoMethods.method2a(a2, h)).start();
//      new Thread(() -> TwoMethods.method2a(a1)).start();
//      new Thread(() -> TwoMethods.method2a(a2)).start();
